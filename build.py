...
<div class="topbar">
  <div class="container topbar__inner">
    ...
    <a class="topbar__shop" href="https://shop.ackermann-spuelmaschinen.de/start,ackermann,de">Zum Händlershop &rarr;</a>
  </div>
</div>
...
PAGES["/kontakt/"] = ("kontakt/index.html", "Kontakt", page(
 ...
 + '<section class="section"><div class="container contact">'
   + """<div class="contact__info">
     ...
     <a href="https://shop.ackermann-spuelmaschinen.de/start,ackermann,de" class="btn btn--primary">Zum Händlershop</a>
   </div>
